...
public class MinMaxSliderDrawer : PropertyDrawer
{
    ...
    {
        var minMaxAttribute = (FloatRangeAttribute)attribute;
        var propertyType = property.propertyType;

        label.text += "(" + minMaxAttribute.min.ToString("F2") + " to " + minMaxAttribute.max.ToString("F2") + ")";
        ...
        if (propertyType == SerializedPropertyType.Vector2)
        {
            ...
            /*
            GUILayoutOption[] halfHeight = new GUILayoutOption[] { GUILayout.Height(100), GUILayout.Width(100) };
            EditorGUILayout.MinMaxSlider(ref minVal, ref maxVal,
            minMaxAttribute.min, minMaxAttribute.max, halfHeight);
            */
